<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="">
	...
	<input type="hidden" name="post[submit]" value="click_total"/>
...
<div class="pageHeader">
	<form method="post" action="<?php echo U('/Home/Daikuan/click_total');?>" onsubmit="return navTabSearch(this);">
		<input type="hidden" name="post[submit]" value="click_total">
		<div class="searchBar">
			<div class="header">
				<p>
			...
			<div class="hbtn">
				...
				<a rel="Daikuan" target="navTab" href="/index.php/Home/Daikuan/click_total" res_title="false"><button class="ch-btn-skin ch-btn-small ch-icon-refresh">重 置</button></a>
			</div>
		</div>
	</form>
</div>
<div class="pageContent">
	<div class="panelBar selbutton">
		<?php echo getaction_select(Daikuan,click_total);?>
	</div>
	<table class="table" width="100%" layoutH="140">
		<thead>
			<tr>
				<th width="8%" align='center'>渠道名称</th>
				<th width="8%" align='center'>奖项名称</th>
				<th width="8%" align='center'>奖项描述</th>
				<th width="10%" align='center'>推送次数</th>
				<th width="10%" align='center'>领取次数</th>
				<!-- <th width="10%" align='center'>转盘点击次数</th> -->
				<th width="10%" align='center'>领取率</th>
				<th width="10%" align='center'>出价</th>
				<th width="10%" align='center'>总计</th>
	...
	<script type="text/javascript">		
		...
		$(document).ready(function(){
			...
			tabscontent.find('a[note-type="getstatis"]').on('click',  function(){
				...
				var url 	    = exportdata ? '/index.php/Home/Daikuan/click_total' + exportdata + '&submit=click_total&ajax=loading' : '/index.php/Home/Daikuan/click_total?submit=click_total&ajax=loading';
