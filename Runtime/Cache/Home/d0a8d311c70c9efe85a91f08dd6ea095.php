<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="">
	...
	<input type="hidden" name="post[submit]" value="other_click"/>
...
<div class="pageHeader">
	<form method="post" action="<?php echo U('/Home/Daikuan/other_click');?>" onsubmit="return navTabSearch(this);">
		<input type="hidden" name="post[submit]" value="other_click">
		<div class="searchBar">
			<div class="header">
				<p>
			...
			<div class="hbtn">
				...
				<a rel="Daikuan" target="navTab" href="/index.php/Home/Daikuan/other_click" res_title="false"><button class="ch-btn-skin ch-btn-small ch-icon-refresh">重 置</button></a>
			</div>
		</div>
	</form>
</div>
<div class="pageContent">
	<div class="panelBar selbutton">
		<?php echo getaction_select(Daikuan,other_click);?>
	</div>
	<table class="table" width="100%" layoutH="140">
		<thead>
			<tr>
				<th width="10%" align='center'>渠道名称</th>
				<th width="8%" align='center'>跳转位置</th>
				<th width="10%" align='center'>展现次数</th>
				<th width="10%" align='center'>点击次数</th>
				<th width="10%" align='center'>点击率</th>
	...
	<script type="text/javascript">		
		...
		$(document).ready(function(){
			...
			tabscontent.find('a[note-type="getstatis"]').on('click',  function(){
				...
				var url 	    = exportdata ? '/index.php/Home/Daikuan/other_click' + exportdata + '&submit=other_click&ajax=loading' : '/index.php/Home/Daikuan/other_click?submit=other_click&ajax=loading';
